...
class OptionsController(QObject):
    ...
    def __init__(self, view : OptionsViewer, image_model : ImageModel = None, option_model : OptionsModel = None):
        super().__init__()
        self.view = view
    ...
    def setup_connections(self):
        ...
        self.view.settings_scrollview.child_widget.load_image_clicked.connect(self.on_load_clicked)
        self.view.button.clicked.connect(self.handle_main_button)
        self.option_model.options_changed.connect(self.view.settings_scrollview.child_widget.show_options)
    ...
    def update_options(self, options_dict : dict):
        print("Updating options with:", options_dict)
        # Update model or view based on new options
        pass
